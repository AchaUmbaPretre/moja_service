                ...
                <div className="blogWrapper-left">
                    <div className="blogWrapper-img">
                        ...
                        <div className="blogcoupe">
                            ...
                            <img src={blog4} alt="" className="blogCoupe-img" />
                            ...
                            <img src={blog5} alt="" className="blogCoupe-img" />
                            ...
                            <img src={blog6} alt="" className="blogCoupe-img" />
                            <img src={blog3} alt="" className="blogCoupe-img" />
                            <img src={blog8} alt="" className="blogCoupe-img" />
                            <img src={blog9} alt="" className="blogCoupe-img" />
